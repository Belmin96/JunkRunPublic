...
export type JobStatus = 'POSTED' | 'BIDDING' | 'ASSIGNING' | 'ASSIGNED' | 'IN_PROGRESS' | 'EVIDENCE_SUBMITTED' | 'PENDING_PAYOUT' | 'DISPUTED' | 'COMPLETED' | 'CANCELLED'
...
export const JOB_STATUS_LABELS: Record<string, string> = { POSTED: 'Awaiting Estimates', BIDDING: 'Estimates In', ASSIGNING: 'Assigning', ASSIGNED: 'Assigned', IN_PROGRESS: 'In Progress', EVIDENCE_SUBMITTED: 'Photo Submitted', PENDING_PAYOUT: 'Verifying', DISPUTED: 'Disputed', COMPLETED: 'Completed', CANCELLED: 'Cancelled' }
...
export const PICKUP_WARNING_MINUTES = 30
export const PICKUP_DEADLINE_MINUTES = 45
